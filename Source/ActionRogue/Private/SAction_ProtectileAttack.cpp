#include "SAction_ProtectileAttack.h"
#include "GameFramework/Character.h"
#include "Kismet/GameplayStatics.h"

USAction_ProtectileAttack::USAction_ProtectileAttack() {
	HandSocketName = "Muzzle_01";
	AttackAnimDelay = 0.2f;
}

void USAction_ProtectileAttack::StartAction_Implementation(AActor* Instigator) {
